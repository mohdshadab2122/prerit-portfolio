...
export default function Home() {
  ...
  return (
    <div className="w-full bg-white">
      {/* Hero Section */}
      <section className="relative pt-28 md:pt-32 pb-10 md:pb-12 px-6 overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-14">
              <div className="flex items-center gap-4">
                ...
                <h2 className="text-4xl font-bold tracking-tight text-[#0D0D0D]">
                  Professional Experience
                </h2>
              </div>
              <Link
              ...
              {experiences
                ...
                .map((exp, index) => (
                  ...
                  >
                    ...
                    <h3 className="text-xl font-bold mb-2 text-[#0D0D0D] group-hover:text-[#0A5CE6] transition-colors">
                      {exp.role}
                    </h3>
                    <div className="text-[#0D0D0D]/60 font-medium mb-6">
                      {exp.company}
                    </div>
                    {exp.roleDesc && (
              ...
              {education
                ...
                .map((edu, index) => (
                  ...
                  >
                    ...
                    <h3 className="text-2xl font-bold mb-2 text-[#0A5CE6] leading-tight">
                      {edu.degree}
                    </h3>
                    <div className="text-xl font-bold text-[#0D0D0D]/85 mb-2">
                      {edu.major}
                    </div>
                    <div className="text-[#0D0D0D]/60 font-medium italic mb-6">
                      {edu.specialization}
                    </div>
              ...
              {awards
                ...
                .map((award: any, index: number) => (
                  ...
                  >
                    ...
                    <h3 className="text-lg font-bold mb-2 leading-tight text-[#0D0D0D]">
                      {award.title}
                    </h3>
